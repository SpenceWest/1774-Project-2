...
class TransformerVisual(QGraphicsItem):
    def __init__(self, transformer: Transformer, bus1_visual: BusVisual, bus2_visual: BusVisual):
        super().__init__()
    ...
    def paint(self, painter, option, widget): # Makes the shape for the Transformer bases off the connected buses
        p1 = self.bus1_visual.scenePos()
        p2 = self.bus2_visual.scenePos()
