...
if __name__ == "__main__":
    ...
    circuit2.buses["Bus 1"].vpu = 1.0
    circuit2.buses["Bus 2"].vpu = 1.0

    circuit2.buses["Bus 1"].delta = 0
    circuit2.buses["Bus 2"].delta = 0

    # T1 + transmission line + T2 modeled as one series branch
    # X_total = 0.10 + 0.1050 + 0.10 = 0.305 pu  (r = 0, no shunt)
    circuit2.add_transformer("T1+Line+T2", "Bus 1", "Bus 2", r=0.0, x=0.305)

    # Generator G at Bus 1  (X'' = 0.15 pu on 100 MVA generator base)
    circuit2.add_generator("G", "Bus 1", voltage_setpoint=1.0, mw_setpoint=100.0,
                           x_subtransient=0.15)

    # Motor M at Bus 2  (X'' = 0.20 pu on 100 MVA motor base)
    circuit2.add_generator("M", "Bus 2", voltage_setpoint=1.0, mw_setpoint=100.0,
                           x_subtransient=0.20)
    ...
    print("\nExpected:")
    print("  Z_nn  = j0.11565 pu")
    print("  I_F'' = -j8.6468 pu")
    print("  E_1   =  0.00000 pu")
    print("  E_2   =  0.60398 pu")